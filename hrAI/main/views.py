...
from .forms import CompanyForm, JobProfileForm
from django.views.generic.edit import CreateView
from django.contrib.auth.forms import UserCreationForm, AuthenticationForm
from .models import Company, JobProfile, Candidate
...
class JobProfileCreateView(CreateView):
    ...
    template_name = 'main/jobprofile_create.html'
...
class JobProfileUpdateView(UpdateView):
    model = JobProfile
    form_class = JobProfileForm
    template_name = 'main/jobprofile_update.html'

    def form_valid(self, form):
        response = super().form_valid(form)
        self.object.evaluate_candidates()
        return response
    
    def get_success_url(self):
        return reverse_lazy('jobprofile_detail', kwargs={'pk': self.object.pk})

class JobProfileDetailView(DetailView):
    model = JobProfile
    template_name = 'main/jobprofile_detail.html'

class JobProfileDeleteView(DeleteView):
    model = JobProfile
    template_name = 'main/jobprofile_confirm_delete.html'
